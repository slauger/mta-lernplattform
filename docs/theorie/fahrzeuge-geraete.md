...
- [x] Die wichtigsten Feuerwehrfahrzeuge benennen und ihre Einsatzzwecke erklären
- [x] Die Beladung eines Löschfahrzeugs beschreiben
- [x] Löschgeräte (Pumpen, Schläuche, Strahlrohre) erklären
- [x] Rettungsgeräte (Leitern, hydraulisches Rettungsgerät) kennen
- [x] Die Persönliche Schutzausrüstung (PSA) benennen
- [x] Atemschutzgeräte unterscheiden
...
!!! info "DLK nur bei größeren Wehren"
...
**Beispiel:**
Ein LF 20 hat eine Frontpumpe mit 2000 L/min Förderleistung. Der Maschinist bedient die Pumpe vom Pumpenbedienstand aus.
...
**Beispiel:**
Bei einem Waldbrand wird die TS an einen Bach gestellt, um Löschwasser zu fördern.
...
**Beispiel:**
Der Wassertrupp legt drei B-Schläuche vom Hydranten zum Fahrzeug (60 Meter).
...
**Beispiel:**
Der Angriffstrupp nimmt ein C-Schlauchpaket (3x15m = 45m) und geht ins brennende Haus vor.
...
!!! success "Standard im Innenangriff"
...
**Beispiel:**
Dachstuhlbrand: Der Maschinist setzt das Wenderohr ein, um von außen zu löschen, während die Trupps ins Gebäude vorgehen.
...
**Beispiel:**
Ein B-Schlauch vom Fahrzeug zum Verteiler. Vom Verteiler gehen zwei C-Schläuche ab: einer zum Angriffstrupp, einer zum Schlauchmaterialtrupp.
...
**Beispiel:**
Nach einem Autounfall ist die Fahrertür eingeklemmt. Der Spreizer öffnet die Tür, um die Person zu befreien.
...
**Beispiel:**
Um eine eingeklemmte Person aus einem PKW zu retten, wird das Dach mit der Schere abgetrennt.
...
**Beispiel:**
Ein LKW ist umgestürzt und klemmt eine Person ein. Mit Hebekissen wird der LKW angehoben.
...
6. **Feuerwehrgurt (Haltegurt)**
   - Mit Karabinerhaken
   - Für Absturzsicherung
   - Zum Befestigen von Gerät

!!! danger "PSA ist Pflicht!"
...
4. Gurt anlegen (festziehen!)
5. Helm aufsetzen (festziehen!)
...
??? question "1. Wie viele Personen passen in ein LF 20?"
    **Antwort:** 9 Personen (1 Gruppenführer + 4 Trupps à 2 Personen)

??? question "2. Welchen Durchmesser hat ein B-Schlauch?"
    **Antwort:** 75 mm

??? question "3. Wofür steht HLF?"
    **Antwort:** Hilfeleistungslöschfahrzeug (kombiniert Löschen + Technische Hilfe)

??? question "4. Welches Strahlrohr ist Standard im Innenangriff?"
    **Antwort:** Hohlstrahlrohr (kegelförmiger Strahl, kühlend, Schutz des Trupps)

??? question "5. Was gehört zur PSA?"
    **Antwort:** Stiefel, Überhose, Jacke, Helm, Handschuhe, Feuerwehrgurt

??? question "6. Wie lange hält ein Pressluftatmer (PA)?"
...
- [Goldkronach: Lokale Fahrzeuge](../goldkronach.md) – Welche Fahrzeuge hat Goldkronach?
- [Praxis: Schläuche kuppeln](../praxis/uebungen-fitness.md) – Schläuche richtig verbinden
- [Praxis: Knoten](../praxis/knoten.md) – Leinen befestigen am Gerät
