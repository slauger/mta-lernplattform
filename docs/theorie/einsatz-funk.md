# Verhalten im Einsatz & Funk

## Lernziele

Nach diesem Kapitel kannst du:

- [x] Den Ablauf von der Alarmierung bis zum Einsatzende beschreiben
- [x] Dich korrekt an der Einsatzstelle verhalten
- [x] Befehle verstehen und ausführen
- [x] Grundlagen des Digitalfunks anwenden
- [x] Funksprüche korrekt absetzen
- [x] Häufige Anfängerfehler vermeiden
...
**Niemals trennen!**
Der Trupp bleibt **immer zusammen** – auch wenn es schneller gehen würde, sich aufzuteilen!
...
!!! warning "Als Truppmann ohne Atemschutz"
...
!!! warning "Richtigen Kanal wählen!"
...
1. **Erst hören, dann senden!**
   - Prüfe, ob der Kanal frei ist
   - Warte, bis andere ausgesprochen haben

2. **Kurz und präzise**
   - Keine Romane erzählen
   - Nur das Wichtigste

3. **Keine privaten Gespräche**
   - Funk ist nur für Einsatz/Übung

4. **Klar sprechen**
   - PTT-Taste **erst** drücken, **dann** sprechen
   - Langsam und deutlich

5. **"Kommen" und "Ende"**
   - **"Kommen"** = Ich bin fertig, erwarte Antwort
   - **"Ende"** = Gespräch beendet, keine Antwort nötig
...
**Beispiel:**
Einsatzort "Bürg" → "Berta-Ulrich-Richard-Gustav"
...
3. **Angriffstrupp:**
   - Zieht PSA + Atemschutz an (wenn ausgebildet; sonst wartet Trupp auf Atemschutz-Trupp)
   - Nimmt C-Schlauchpaket + Hohlstrahlrohr
   - Geht über Treppe hoch
   - Löscht den Brand in der Küche

4. **Wassertrupp:**
   - Legt B-Schläuche vom Hydranten zum Fahrzeug
   - Kuppelt Schläuche an
   - Öffnet Hydrant

5. **Maschinist:**
   - Startet Pumpe
   - Baut Druck auf (8 bar)
   - Öffnet Ventil für Angriffstrupp

6. **Brandbekämpfung erfolgreich:**
   - Gruppenführer: "Wasser halt!"
   - Nachlöscharbeiten (Glut ablöschen)
   - Rauch mit Lüfter entfernen
...
3. **Angriffstrupp:**
   - Holt Spreizer + Schere vom RW/HLF
   - Spricht mit Verletztem (beruhigen!)
   - Öffnet Tür mit Spreizer
   - Befreit Person (zusammen mit Rettungsdienst)

4. **Wassertrupp:**
   - Bindet Ölspur mit Bindemittel ab
   - Verhindert, dass Öl ins Grundwasser läuft
...
1. **Schläuche waschen und trocknen**
   - Schmutziges Wasser rausspülen
   - Zum Trocknen aufhängen (Schlauchturm)

2. **Geräte reinigen**
   - Strahlrohre, Verteiler abspülen
   - Atemschutzgeräte reinigen und prüfen

3. **Fahrzeug auffüllen**
   - Wassertank auffüllen
   - Schaummittel nachfüllen
   - Verbrauchtes Material ersetzen (z. B. Feuerlöscher)

4. **Fahrzeug und Geräte wieder **einsatzbereit** machen

!!! tip "Gemeinschaftsaufgabe!"
...
!!! success "Fehler ansprechen ist okay!"
...
**Warum?**
Ruß, Rauch und Chemikalien sind **krebserregend**! Kontakt minimieren!
...
- [Praxis: Übungen](../praxis/uebungen-fitness.md) – Einsatzübungen simulieren
- [Prüfungsfragen](../pruefung/fragen.md) – Teste dein Wissen zu Einsatz & Funk!
