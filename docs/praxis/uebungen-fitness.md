...
- [x] Praktische Feuerwehrübungen zuhause durchführen
- [x] Ein feuerwehrspezifisches Fitnessprogramm erstellen
- [x] Deine körperliche Leistungsfähigkeit verbessern
- [x] Dich optimal auf die physischen Anforderungen der MTA vorbereiten
...
3. **Kohlenhydrate** (Energie): Vollkorn, Haferflocken, Reis
4. **Fette** (Hormone, Gelenke): Nüsse, Avocado, Olivenöl
5. **Viel Wasser** (2-3 Liter/Tag)
...
!!! tip "Nicht perfekt? Kein Problem!"
...
- [Knoten](knoten.md) – Kombiniere Knoten-Üben mit Fitness!
- [Materialliste](materialliste.md) – Was brauchst du fürs Training?
- [Lernfortschritt](../lernfortschritt.md) – Dokumentiere deine Fitness-Fortschritte!
